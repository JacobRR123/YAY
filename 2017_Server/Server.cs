    ...
    class Program
    {
        ...
        Tutorial:
            if (Setup.firsttime == true)
            {
                ...
                Console.Title = "NetRec Nightly Intro";
                Console.WriteLine("Welcome to NetRec Nightly " + appversion + "!");
                Console.WriteLine("Is this your first time using NetRec Nightly?");
                Console.WriteLine("Yes or No (Y, N)");
                string readline22 = Console.ReadLine();
                if (readline22 == "y" || readline22 == "Y")
                {
                    Console.Clear();
                    Console.Title = "NetRec Nightly Tutorial";
                    Console.WriteLine("In that case, welcome to NetRec Nightly!");
                    Console.WriteLine("NetRec Nightly is server software that emulates the old servers of previous RecRoom versions.");
                    Console.WriteLine("To use NetRec Nightly, you'll need to have builds aswell!");
                    ...
                    Console.WriteLine(new WebClient().DownloadString("https://raw.githubusercontent.com/JacobRR123/NetRec/master/Update/builds.txt"));
        ...
        Start:
            Console.Title = "NetRec Nightly Startup Menu";
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("NetRec Nightly - Open source Old RecRoom server software. (Version: " + appversion + ")");
            Console.WriteLine("Made and provided by JacobRR123.");
            Console.WriteLine("There Is No Source Code Because This Is Nightly");
            Console.WriteLine("Might Be Unfinshed");
            Console.WriteLine("Discord: https://discord.gg/B8vQMC52MH" + Environment.NewLine);
            if (!(new WebClient().DownloadString("https://raw.githubusercontent.com/JacobRR123/NetRec/master/Download/version.txt").Contains(appversion)))
            {
                Console.WriteLine("This version of NetRec Nightly is outdated. We recommend you install the latest version, NetRec Nightly " + new WebClient().DownloadString("https://raw.githubusercontent.com/JacobRR123/NetRec/master/Download/version.txt"));
            }
            if (File.Exists("SaveData\\Profile\\userid.txt"))
            {
                if (new WebClient().DownloadString("https://raw.githubusercontent.com/JacobRR123/NetRec/master/Update/banned.txt").Contains(File.ReadAllText("SaveData\\Profile\\userid.txt")))
                {
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("You are banned. Using this version of NetRec Nightly will not work, please download NetRec Nightly 0.4.2 or prior.");
                    Console.ForegroundColor = ConsoleColor.Red;
                    bannedflag = true;
                }
            }
            ...
            if (readline == "1")
            {
                Console.Title = "NetRec Nightly Changelog";
                Console.Clear();
                Console.WriteLine(new WebClient().DownloadString("https://raw.githubusercontent.com/JacobRR123/NetRec/master/Download/changelog.txt"));
            ...
            if (readline == "2")
            {
                ...
                {
                    Console.Title = "NetRec Nightly Custom Room Downloader";
                    Console.Clear();
            ...
            Profile:
                ...
                {
                    Console.Title = "NetRec Nightly Profile Downloader";
                    Console.Clear();
            ...
            if (readline == "4")
            {
                Console.Title = "NetRec Nightly Build Downloads";
                Console.Clear();
                Console.WriteLine("To download builds, either go to the builds channel or use the links below: (these links are also available from the #builds channel)" + Environment.NewLine);
                Console.WriteLine(new WebClient().DownloadString("https://raw.githubusercontent.com/JacobRR123/NetRec/master/Update/builds.txt"));
                Console.WriteLine("Download a build and press any key to continue:");
            ...
            if (readline == "5")
            {
                ...
                {
                    Console.Title = "NetRec Nightly October 19th 2017";
                    version = "2017";
                    Console.Clear();
                ...
                else if (readline2 == "2018")
                {
                    ...
                    {
                        Console.Title = "NetRec Nightly September 27th 2018";
                        version = "2018";
                        Console.Clear();
                    ...
                    {
                        Console.Title = "NetRec Nightly July 20th 2018";
                        version = "2018";
                        Console.Clear();
